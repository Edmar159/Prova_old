...
<div class="row">
	 <div class="row col-md-12 col-md-offset-0">    	
	   	<div class="panel panel-primary">
			...
			<form class="form-horizontal" method="GET" action="busTitu.php" >
						...
						<div class="col-md-9">
							<div class="input-group">
								<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></span>
								   	<input type="text" class="form-control" name="busca" placeholder="Título do Filme" aria-describedby="basic-addon1">   
						   	</div>
						</div>
						<div class="col-md-1">
...
{	
	...
	if ($busca == NULL){
		...
		$result = mysqli_query($con, "SELECT * FROM filme WHERE Titulo like '%$busca%'");
	}
}	
		...
		<div class="col-md-12 col-md-offset-0">
				...
				{		
					if(mysqli_num_rows($result) > 0)
					{
						...
						<div class="panel panel-primary">
				  			<div class="panel-heading"><?php if($busca == NULL) { echo "Filmes";} else{echo $busca;} ?></div>
